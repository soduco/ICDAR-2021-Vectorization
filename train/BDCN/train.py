...
def main():
    ...
    model = BDCN(pretrain=args.pretrain, logger=logger)
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train BDCN')
    ...
    help='Load model /lrde/home2/ychen/fine_tuning/BDCN_hybrid_loss/final-model/historical_map_10000.pth'
    )
    ...
    parser.add_argument('-s', '--snapshots', type=int, default=1,
        help='how many iters to store the params, default is 1')
