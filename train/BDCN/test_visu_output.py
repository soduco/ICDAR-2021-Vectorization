...
def parse_args():
    ...
    parser.add_argument('--res-dir', type=str, default='test_results', help='the dir to store result')
    ...
    parser.add_argument('--tile_save_image_path', type=str, default='../best_models/best_models_prediction/BDCN_pretrain_test.png', help='the file path of original image')
