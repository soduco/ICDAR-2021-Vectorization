...
def main():
    ...
    eval_save_path = os.path.join(args.eval_dir, 'BDCN_pretrain_results')
    ...
    plot_dict_path = os.path.join(eval_save_path, 'BDCN_pretrain_plot_info.pkl')
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Evaluation plot for BDCN.')
