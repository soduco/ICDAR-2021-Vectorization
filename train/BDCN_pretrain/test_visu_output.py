...
def parse_args():
    ...
    parser.add_argument('--tile_save_image_path', type=str, default='../best_models/best_models_prediction/BDCN_scratch_test.png', help='the file path of original image')
