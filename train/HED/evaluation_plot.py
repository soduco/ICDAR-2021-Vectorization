...
def main():
    ...
    eval_save_path = os.path.join(args.eval_dir, 'HED_scratch_results')
    ...
    plot_dict_path = os.path.join(eval_save_path, 'HED_scratch_plot_info.pkl')
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Evaluation plot for HED scratch model.')
