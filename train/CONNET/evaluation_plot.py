...
def main():
    ...
    eval_save_path = os.path.join(args.eval_dir, 'CONNET_results')
    ...
    plot_dict_path = os.path.join(eval_save_path, 'CONNET_plot_info.pkl')
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Evaluation plot for CONNET.')
