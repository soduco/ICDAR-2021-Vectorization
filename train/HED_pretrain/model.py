...
class HED(nn.Module):
    """ HED network. """
    def __init__(self, pretrain=None, logger=None, device='cuda'):
    ...
    def forward(self, x):
        ...
        # conv1_2 = self.relu(self.conv1_2(conv1_1))  # Side output 1. [1, 64, 268, 268]
        # pool1   = self.maxpool(conv1_2)

        # conv2_1 = self.relu(self.conv2_1(pool1))
        # conv2_2 = self.relu(self.conv2_2(conv2_1))  # Side output 2. [1, 128, 134, 134]
        # pool2   = self.maxpool(conv2_2)

        # conv3_1 = self.relu(self.conv3_1(pool2))
        # conv3_2 = self.relu(self.conv3_2(conv3_1))
        # conv3_3 = self.relu(self.conv3_3(conv3_2))  # Side output 3. [1, 256, 67, 67]
        # pool3   = self.maxpool(conv3_3)

        # conv4_1 = self.relu(self.conv4_1(pool3))
        # conv4_2 = self.relu(self.conv4_2(conv4_1))
        # conv4_3 = self.relu(self.conv4_3(conv4_2))  # Side output 4. [1, 512, 34, 34]
        # pool4   = self.maxpool(conv4_3)

        # conv5_1 = self.relu(self.conv5_1(pcool4))
        # conv5_2 = self.relu(self.conv5_2(conv5_1))
        # conv5_3 = self.relu(self.conv5_3(conv5_2))  # Side output 5. [1, 512, 17, 17]
