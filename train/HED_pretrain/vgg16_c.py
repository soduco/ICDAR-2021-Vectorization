...
class VGG16_C(nn.Module):
    ...
    def __init__(self, pretrain=None, logger=None):
        ...
        self.conv1_1 = nn.Conv2d(3, 64, (3, 3), stride=1, padding=35)
        ...
        self.conv5_1 = nn.Conv2d(512, 512, (3, 3), stride=1, padding=1)
        self.relu5_1 = nn.ReLU(inplace=True)
        self.conv5_2 = nn.Conv2d(512, 512, (3, 3), stride=1, padding=1)
        self.relu5_2 = nn.ReLU(inplace=True)
        self.conv5_3 = nn.Conv2d(512, 512, (3, 3), stride=1, padding=1)
