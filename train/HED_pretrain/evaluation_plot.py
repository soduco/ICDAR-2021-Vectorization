...
def test(model, weight, args):
    ...
    test_name_lst = os.path.join(val_root, 'test_pair.lst')
...
def main():
    ...
    eval_save_path = os.path.join(args.eval_dir, 'HED_pretrain_results')
    ...
    weight_list = os.listdir(args.weight_folder)[30: 120]
    max_coco_pq_score = 0
    ...
    for weight_name in weight_list:
        if weight_name.endswith('.pth'):
            ...
            EPM_threshold = 0.5
            epm2labelmap(input_path, output_path, EPM_threshold, debug_labels=None)
    ...
    plot_dict_path = os.path.join(eval_save_path, 'HED_pretrain_plot_info.pkl')
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Evaluation plot for HED pretrain.')
    ...
    parser.add_argument('--original_image_path', type=str, default=r'../../data_generator/img_gt/BHdV_PL_ATL20Ardt_1926_0004-VAL-INPUT_color_border.jpg',
        help='the dir to store result')
    parser.add_argument('--weight_folder', type=str, default=r'./params/',
        help='the dir of weights')
    parser.add_argument('--EPM_border', type=str, default=r'../../data_generator/epm_mask/BHdV_PL_ATL20Ardt_1926_0004-VAL-EPM-BORDER-MASK_content.png',
        help='The mask of the EPM_border')
    parser.add_argument('--eval_dir', type=str, default=r'../../evaluation',
    ...
    parser.add_argument('--label_path', type=str, default=r'../../data_generator/img_gt/BHdV_PL_ATL20Ardt_1926_0004-VAL-GT_LABELS_target.png',
        help='The evaluation folder')
    parser.add_argument('--validation_mask', type=str, default='../../data_generator/img_gt/BHdV_PL_ATL20Ardt_1926_0004-VAL-MASK_content.png',
        help='Validation mask to evaluate the results ../../data_generator/img_gt/BHdV_PL_ATL20Ardt_1926_0004-VAL-MASK_content.png')
