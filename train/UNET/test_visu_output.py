...
def parse_args():
    ...
    parser.add_argument('--tile_save_image_path', type=str, default='../best_models/best_models_prediction/UNET_scratch_test.png', help='the file path of original image')
    ...
    parser.add_argument('--channels', type=int, default=3, help='number of channels for unet')
    parser.add_argument('--classes', type=int, default=1, help='number of classes in the output')
